                ...
                <div className="flex items-center justify-between mt-6 pt-4 border-t border-[#333]">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <button
                            ...
                            title={deepthink ? 'DeepThink ON — extra refinement pass for higher quality' : 'DeepThink OFF — standard analysis'}
                            className={`relative flex items-center gap-1.5 px-3 py-2 rounded-lg text-xs font-medium transition-colors border ${deepthink
